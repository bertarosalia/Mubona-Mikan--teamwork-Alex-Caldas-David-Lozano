...
const MyAnimeForm = () => {
  ...
  const { deleteLocalAPI, postLocalAPI } = useAPI();
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          <div className="new-anime__group">
            <label htmlFor="synopsis" className="new-anime__label">
              Synopsis:{" "}
            </label>
            <input
              type="box "
        ...
        <div className="new-anime__group new-anime__group--end">
          <button type="button" onClick={() => deleteLocalAPI(urlAPI, 1)}>
            Delete
          </button>
